  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-white font-bold dark:text-white max-w-4xl">
          Your Trip Itinerary to <span className="text-yellow-500 font-bold text-5xl"> {tripData?.destination}</span> is Ready
        </h2>
       <div className="flex gap-8">
        <div className="flex gap-2 items-center">
        <Calendar/>
        <h2 className="">{tripData?.duration} days</h2>
       </div>
       <div className="flex gap-2 items-center">
        <Wallet/>
